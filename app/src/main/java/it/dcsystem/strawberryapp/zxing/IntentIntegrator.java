...
package it.dcsystem.strawberryapp.zxing;
 ...
 * {@link #initiateScan(Collection)} with a collection containing the
...
public class IntentIntegrator {
    ...
    private final Map<String, Object> moreExtras = new HashMap<>(
            3);
